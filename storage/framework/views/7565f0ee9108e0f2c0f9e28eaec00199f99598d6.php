...
<div class="card">
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td><div class="btn-group">
                            <a type="button" class="btn btn-success" href="<?php echo e(route('clientes.editar', $u->id)); ?>">Datos</a>
        ...
        <br>
        <div class="btn-group">
            <a type="button" class="btn btn-success" href="<?php echo e(route('clientes.create')); ?>">Crear cliente</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sivig\resources\views/clientes/index.blade.php ENDPATH**/ ?>