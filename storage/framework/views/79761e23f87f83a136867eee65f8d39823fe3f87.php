...
<div class="card">
  ...
  <div class="card-body">
    <div class="col-md-6">
      <form role="form" action="<?php echo e(route('articulos.update', $articulo)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('put'); ?>
        <div class="form-group row">
          <div class="col-6">
            <label>Codigo interno</label>
            <input name="cod_interno" required type="text" class="form-control" value="<?php echo e($articulo->cod_interno); ?>">
          </div>
          <div class="col-6">
            <label>Codigo de barras</label>
            <input name="cod_barras" required type="text" class="form-control" value="<?php echo e($articulo->cod_barras); ?>">
          </div>
        </div>
        <div class="form-group">
          <label>Descripcion</label>
          <input name="descripcion" required type="text" class="form-control" value="<?php echo e($articulo->descripcion); ?>">
        </div>
        <div class="form-group row">
          <div class="col-4">
        ...
        <div class="form-group row">
          <div class="col-4">
            ...
            <input name="venta_neto" id="venta_neto" required type="number" oninput="ActualizaValorVentaTotal()"
              class="form-control" value="<?php echo e($articulo->venta_neto); ?>">
          </div>
          <div class="col-4">
            <label>I.V.A.</label>
            <input name="venta_imp" id="venta_imp" required type="number" class="form-control"
              value="<?php echo e($articulo->venta_imp); ?>">
          </div>
          <div class="col-4">
            <label>Total</label>
            <input name="venta_total" id="venta_total" required type="number" oninput="ActualizaValorVentaNeto()"
              class="form-control" value="<?php echo e($articulo->venta_imp + $articulo->venta_neto); ?>">
          </div>
        </div>
        <div class="form-group row">
          <div class="col-6">
            ...
            <input name="por_ganancia" id="por_ganancia" disabled type="number" class="form-control"
              value="<?php echo e(((($articulo->venta_imp + $articulo->venta_neto)-($articulo->costo_imp + $articulo->costo_neto))/($articulo->venta_imp + $articulo->venta_neto))*100); ?>">
          </div>
          <div class="col-6">
            <label>Ganancia</label>
            <input name="ganancia" id="ganancia" disabled type="number" class="form-control"
              value="<?php echo e(number_format(($articulo->venta_imp + $articulo->venta_neto)-($articulo->costo_imp + $articulo->costo_neto), 0,'', '.')); ?>">
          </div>
        </div>
        <div class="form-goup row">
          <div class="col-6">
            ...
            <select id="activo" name="activo" class="form-control">
              ...
              <option selected=true value="2">Inactivo</option <?php endif; ?> </select>
          </div>
          <div class="col-6">
            <label>Stock critico</label>
            <input name="stock_critico" required type="number" class="form-control"
              value="<?php echo e($articulo->stock_critico); ?>">
          </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sivig\resources\views/articulos/editar.blade.php ENDPATH**/ ?>