...
<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e($login_url); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="user" class="form-control <?php echo e($errors->has('user') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('user')); ?>" placeholder="Usuario" autofocus>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sivig\resources\views/auth/login.blade.php ENDPATH**/ ?>