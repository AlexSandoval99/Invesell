...
<div class="card">
  ...
  <div class="card-body">
    <div class="col-md-6">
      <form role="form" action="<?php echo e(route('clientes.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sivig\resources\views/clientes/crear.blade.php ENDPATH**/ ?>